...
public class PlayerBoard implements Serializable {
     ...
     */
    public PlayerBoard(GameCharacter character, String nickname) {
     ...
     */
    public void addDamages(GameCharacter target, int amount) {
     ...
     */
    public void addMarks(GameCharacter target, int amount) {
        for (int i = 0; i < amount; i++) {
     ...
     */
    public void addAmmos(Map<AmmoType, Integer> ammos) {
     ...
     */
    public void useAmmos(Map<AmmoType, Integer> usedAmmos) {
     ...
     */
    public void resetMarks(GameCharacter player) {
